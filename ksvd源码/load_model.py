...
with open("list_test_PSNR.txt", "wb") as fp:
    with torch.no_grad():
        ...
        for k, (image_true, image_noise) in enumerate(dataloader_test, 0):
            ...
            SSIM_init = skimage.measure.compare_ssim(img1, img1_noise1, data_range=255) #一定要转换为原图才可以
            ...
            PSNR = PSNR.cpu()
            SSIM_test = skimage.measure.compare_ssim(img1,real_denoise, data_range=255)
